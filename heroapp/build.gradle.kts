...
android {
    namespace = "com.preachooda.heroapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.preachooda.heroapp"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.preachooda.heroapp.composeTestUtils.CustomTestRunner"
        vectorDrawables {
