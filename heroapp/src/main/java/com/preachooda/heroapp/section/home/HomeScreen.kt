package com.preachooda.heroapp.section.home
...
import com.preachooda.heroapp.section.home.domain.HomeScreenIntent
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            ElevatedCard( // open patrolling screen
                ...
                onClick = {
                    navController.navigate(Screens.Patrolling.route)
                },
            ) {
                Row(
                    modifier = Modifier
            ...
            ElevatedCard( // open ticket screen
                shape = RoundedCornerShape(10.dp),
                modifier = Modifier
                    .fillMaxWidth()
                    .height(120.dp)
                ...
                Row(
                    ...
                    Text(text = "Заявка на оказание помощи")
                    Icon(
                        painter = painterResource(id = R.drawable.ic_arrow_open),
                        contentDescription = "Icon arrow open",
                        tint = PurpleGrey40
