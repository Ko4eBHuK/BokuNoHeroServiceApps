...
android {
    namespace = "com.preachooda.adminapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.preachooda.adminapp"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.preachooda.adminapp.composeTestUtils.CustomTestRunner"
        vectorDrawables {
        ...
        buildConfigField(
            "String",
            "API_URL",
            rootProject.properties["api_url"] as String
        )
        buildConfigField(
            "String",
            "MAPTILER_API_KEY",
        ...
        buildConfigField(
            "String",
            "DATE_COMMON_FORMAT",
            rootProject.properties["date_common_format"] as String
        )
    }
