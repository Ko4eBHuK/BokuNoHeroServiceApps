...
class QualificationTicketTest {
    ...
    fun successCreateQualificationTicket() {
        ...
        composeTestRule.onNodeWithText("Герой 1, Причуда").assertExists()
        composeTestRule.onNodeWithText("Герой 1, Причуда").performClick()
        composeTestRule.waitUntilTimeout(1000L)
        ...
        composeTestRule.onNodeWithText("Заявление №3 на экзамен отправлено").assertExists()
    }
