...
fun createImageFile(fileName: String = "", userId: String = ""): File {
    val timeStamp = SimpleDateFormat("yyyyMMdd_HHmmss").format(Date())
    val imageFileName = "JPEG_" + timeStamp + "_$userId.jpg"
    return File(
...
@SuppressLint("SimpleDateFormat")
fun createVideoFile(fileName: String = "", userId: String = ""): File {
    val timeStamp = SimpleDateFormat("yyyyMMdd_HHmmss").format(Date())
    val videoFileName = "MP4_" + timeStamp + "_$userId.mp4"
    return File(
...
@SuppressLint("SimpleDateFormat")
fun createAudioRecordingFile(fileName: String = "", userId: String = ""): File {
    val timeStamp = SimpleDateFormat("yyyyMMdd_HHmmss").format(Date())
    val audioFileName = "recording_" + timeStamp + "_$userId.mp3"
    return File(
